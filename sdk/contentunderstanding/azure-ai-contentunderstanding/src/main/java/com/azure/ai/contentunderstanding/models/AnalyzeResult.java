...
public final class AnalyzeResult implements JsonSerializable<AnalyzeResult> {
    ...
    /**
     * Get the stringEncoding property: The string encoding used for content spans.
     * 
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("stringEncoding",
            this.stringEncoding == null ? null : this.stringEncoding.toString());
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("contents".equals(fieldName)) {
                    ...
                    stringEncoding = StringEncoding.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }
